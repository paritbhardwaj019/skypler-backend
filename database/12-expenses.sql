...
VALUES
  (1, 1, '2023-06-18', 'Material', 100, 0, 'Cement', 10.50, 'Unpaid', 0, 1050.00, NULL, NULL),
  (2, 1, '2023-06-19', 'Material', 500, 0, 'Steel', 5.00, 'Unpaid', 0, 2500.00, NULL, NULL),
  (3, 1, '2023-06-20', 'Material', 200, 0, 'Concrete', 80.00, 'Unpaid', 0, 16000.00, NULL, NULL),
  (4, 1, '2023-06-20', 'Material', 1000, 0, 'Bricks', 0.50, 'Unpaid', 0, 500.00, NULL, NULL),
  (5, 1, '2023-06-21', 'Material', 50, 0, 'Wood', 150.00, 'Unpaid', 0, 7500.00, NULL, NULL),
  (6, 1, '2023-06-22', 'Material', 20, 0, 'Glass', 30.00, 'Unpaid', 0, 600.00, NULL, NULL),
  (7, 1, '2023-06-18', 'Material', 100, 0, 'Aluminum', 15.00, 'Unpaid', 0, 1500.00, NULL, NULL),
  (8, 1, '2023-06-18', 'Material', 200, 0, 'Plastic', 2.50, 'Unpaid', 0, 500.00, NULL, NULL),
  (9, 1, '2023-06-18', 'Material', 50, 0, 'Stone', 100.00, 'Unpaid', 0, 5000.00, NULL, NULL),
  (10, 1, '2023-06-10', 'Material', 10, 0, 'Asphalt', 200.00, 'Unpaid', 0, 2000.00, NULL, NULL),
  (11, 1, '2023-06-11', 'Material', 500, 0, 'Tiles', 25.00, 'Unpaid', 0, 12500.00, NULL, NULL),
  (12, 1, '2023-06-12', 'Material', 100, 0, 'Plaster', 15.00, 'Unpaid', 0, 1500.00, NULL, NULL),
  (13, 1, '2023-06-13', 'Material', 50, 0, 'Insulation materials', 80.00, 'Unpaid', 0, 4000.00, NULL, NULL),
  (14, 1, '2023-06-14', 'Material', 200, 0, 'Roofing materials (e.g., shingles)', 5.00, 'Unpaid', 0, 1000.00, NULL, NULL),
  (15, 1, '2023-06-15', 'Material', 1000, 0, 'Electrical wiring and cables', 2.00, 'Unpaid', 0, 2000.00, NULL, NULL),
  (16, 1, '2023-06-16', 'Material', 500, 0, 'Plumbing pipes and fittings', 3.50, 'Unpaid', 0, 1750.00, NULL, NULL),
  (17, 1, '2023-06-17', 'Material', 50, 0, 'Paints and coatings', 20.00, 'Unpaid', 0, 1000.00, NULL, NULL),
  (18, 1, '2023-06-18', 'Material', 100, 0, 'Adhesives and sealants', 5.00, 'Unpaid', 0, 500.00, NULL, NULL),
  (19, 1, '2023-06-19', 'Material', 200, 0, 'Reinforcement bars', 3000.00, 'Unpaid', 0, 600000.00, NULL, NULL),
  (20, 1, '2023-06-20', 'Material', 1000, 0, 'Aggregates (e.g., sand, gravel)', 50.00, 'Unpaid', 0, 50000.00, NULL, NULL),
